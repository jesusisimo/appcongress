...
$respuesta->mensaje = "Aun no estas registrado, por favor crea una cuenta.";

$query="SELECT * FROM usuarios WHERE email='".$_POST['email']."' LIMIT 1";
$usuarios=$bd->ExecuteE($query);
foreach ($usuarios as &$usuario){
    if($usuario['password']==""){
        $respuesta->mensaje = "No cuentas con contraseña ya que te registraste mediante facebook, Ingresa con tu cuenta de facebook";
    }else{
        $html='<!DOCTYPE html>
        <html lang="en">
                                        ...
                                        <table class="section-item" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td  align="justify" style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                    ...
                                                    Estimad@ '.$usuario['nombre'].' '.$usuario['apellidos'].'.<br>
                                                    Le enviamos sus datos de acceso para el '.$sociedad['nombre_sistema'].'.<br>
        ...
        <tr><td height="30"></td></tr>
                  ...
                  $asunto   = utf8_decode("Recuperación de su contraseña");
                  $mensaje=$html;
                  $mail = new phpmailer();
                  $mail->PluginDir = "mail/";
                  $mail->Mailer = "smtp";
                  ...
                  if($mail->Send()){
                    $respuesta->mensaje = "Te enviamos tu contraseña a tu correo";
                  }else{
                    $respuesta->mensaje = "No se pudo enviar tu contraseña, intenta mas tarde";
                  }
              }
   }
